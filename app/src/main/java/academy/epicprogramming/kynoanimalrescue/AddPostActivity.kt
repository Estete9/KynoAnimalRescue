...
class AddPostActivity : AppCompatActivity() {
    ...
    when{
        imageUri == null -> Toast.makeText(this, "Please select a picture to post", Toast.LENGTH_LONG).show()
        TextUtils.isEmpty(description_post.toString()) -> Toast.makeText(this, "Please write a description for your post", Toast.LENGTH_LONG).show()

        else ->{
            val progressDialog = ProgressDialog(this)
            progressDialog.setTitle("Adding New Post")
            progressDialog.setMessage("Please wait while your post updates")
            progressDialog.show()
